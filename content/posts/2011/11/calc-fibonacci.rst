...
[latex]a^n=\\begin{cases}a^{n/2}\\times a^{n/2}&,\\text{ if }x\\text{ is
even}\\\\a^{(n-1)/2}\\times a^{(n-1)/2}\\times a&,\\text{ if }x\\text{
is odd}\\end{cases}[/latex]
...
[wptabtitle]Without numpy Library[/wptabtitle]
...
大整数乘法`_\ ）。以Karatsuba算法为例，矩阵法的时间复杂度递推方程为：[latex]T(n)=T(n/2)+O(n^{\\log\_2{3}})[/latex]，应用\ `Master定理`_\ 求得[latex]T(n)=O(n^{\\log\_2{3}})[/latex]。因此对于很大的n，矩阵法的时间复杂度为\ **O(n
^ 1.585)**\ ，空间复杂度\ **O(n)**\ 。
...
.. _算法复杂度: http://www.gocalf.com/blog/algorithm-complexity-and-master-theorem.html
.. _Master定理: http://www.gocalf.com/blog/algorithm-complexity-and-master-theorem.html
.. _fibonacci\_data: http://www.gocalf.com/blog/wp-content/uploads/2011/11/fibonacci_data.zip
...
.. _fibonacci\_timecost: http://www.gocalf.com/blog/wp-content/uploads/2011/11/fibonacci_timecost.zip

.. |compare\_a| image:: http://www.gocalf.com/blog/wp-content/uploads/2011/11/compare_a.png
.. |compare\_b| image:: http://www.gocalf.com/blog/wp-content/uploads/2011/11/compare_b.png
.. |compare\_c| image:: http://www.gocalf.com/blog/wp-content/uploads/2011/11/compare_c.png
.. |compare\_d| image:: http://www.gocalf.com/blog/wp-content/uploads/2011/11/compare_d.png
.. |compare\_e| image:: http://www.gocalf.com/blog/wp-content/uploads/2011/11/compare_e.png
